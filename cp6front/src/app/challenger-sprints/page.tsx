export default function ChallengerSprints() {
    return (
      <div className="p-4">
        <h2 className="text-xl font-bold">Challenger Sprints</h2>
        ...
        <a href="https://github.com/ovitortadeu/challenge-front-end" target="_blank" rel="noopener noreferrer" className="inline-block mt-4 text-blue-500 no-underline hover:text-blue-700 transition duration-200">Vitor e Pedro: 6/10 <a/>
        ...
        <a href="https://github.com/ovitortadeu/challenge-front-end" target="_blank" rel="noopener noreferrer" className="inline-block mt-4 text-blue-500 no-underline hover:text-blue-700 transition duration-200">Vitor e Pedro: 5,5/10 <a/>


        <p className="text-xl font-bold mb-4">Sprint3</p>
        <p>Na terceira entrega foi a troca para react alem de leves melhorias</p>
