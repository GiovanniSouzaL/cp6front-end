export default function CheckPoints() {
  return (
    <div className="p-4">
      ...
      <p>Nesse CP foi pedido a criação de um site com todos os cursos da FIAP + suas páginas favoritas.</p>
      ...
      <a href="https://github.com/ovitortadeu/cp1" target="_blank" rel="noopener noreferrer" className="inline-block mt-4 text-blue-500 no-underline hover:text-blue-700 transition duration-200">Vitor CP1: 7.5/10</a>

      <p className="text-xl font-bold mt-6 mb-4">Cp2</p>
      <p>Nesse CP foi pedido um protótipo no Figma, onde cada grupo ficou com uma parte para realizar, e no final cada representante do grupo uniu as partes.</p>
